...
- **Not in this change:**
  ...
  - a graceful engine stop when the app quits;
...
- `desktop-gui`: added "The engine does not leave its unpacked copy behind", covering the longer graceful stop and startup removal of dead extraction folders owned by the app's sidecar.
