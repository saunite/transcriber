...
The system SHALL optionally save captured audio (system and/or microphone) to WAV files alongside the transcript, and SHALL merge system and mic recordings into a stereo WAV when both exist.
