...
Identify speaker turns in audio using pyannote.audio, merge diarization with transcription, and report/format per-speaker statistics when diarization is enabled.
