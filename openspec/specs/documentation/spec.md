...
Ensure the project's documentation stays in sync with the tool's user-facing capabilities, so users can discover supported commands, platform setup and launchers, and contributors can find how work is done and how artifacts are built.
