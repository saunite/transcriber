...
REM echo Auto-stop after 10 minutes of silence (use --silence-timeout 0 to disable)
echo.
...
python transcriber.py --live --wasapi --include-mic --model base --output "%output_file%" --chunk-duration 10  --silence-timeout 0
